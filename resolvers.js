...
const resolvers = {
  ...
  Query: {
    ...
    getEnrolled: async (_,{course}) => {


    const trainees = await Trainee.find({ 'registeredCourses.course': course }).populate('registeredCourses');
    // Find the trainees that have the specified courseId in their registeredCourses field and populate the corresponding course information
